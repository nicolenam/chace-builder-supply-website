...
{/*       
      ...
      <div className="secondMenu">
        <div className="secondMenuItem"><a className="sc-cjHJEj kQbLAY"><p color="#12856e" className="sc-hOqqkJ sc-iXYxDx hsIUPF gqBqms" onClick={handleClick}>All Products</p></a><a className="sc-JooDp huvkpK" href="/quotes"><p color="#12856e" className="sc-hOqqkJ sc-iXYxDx hsIUPF gqBqms">Quotes</p></a><a className="sc-JooDp huvkpK" href="/make-payment"><p color="#12856e" className="sc-hOqqkJ sc-iXYxDx hsIUPF gqBqms">Payments</p></a><a className="sc-JooDp huvkpK" href="/about"><p color="#12856e" className="sc-hOqqkJ sc-iXYxDx hsIUPF gqBqms">About</p></a><a className="sc-JooDp huvkpK" href="/contact"><p color="#12856e" className="sc-hOqqkJ sc-iXYxDx hsIUPF gqBqms">Contact</p></a></div>
